...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function hitungBPHTB() {
            total_hitung = total;
            if($('#hargaTransaksi').val() > total){
                total_hitung = $('#hargaTransaksi').val();
        ...
        $("#form-objek-pajak").validate({
            submitHandler: function (form) {
                ...
                luasBumiSertifikatObjekPajak = $('input#luasBumiSertifikatObjekPajak').val();
                luasBangunanSertifikatObjekPajak = $('input#luasBangunanSertifikatObjekPajak').val();
        ...
        $('body').delegate('.delete_objek', 'click', function (event) {
            ...
            if (a) {
                ...
                if (no == 0) {
                    $('table.table-objek-pajak tbody').html('<tr><td colspan="7">Belum ada Objek Pajak</td></tr>');
                }
                $('table.table-objek-pajak tfoot').html("<tr><td colspan='6'><b>TOTAL</b></td><td class='text-right'>" + rupiah(total, true) + "</td></tr>");
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        if(data.status == false){
                            ...
                            $('#luasTanahObjekPajak').val(data.LUASBUMI);
                            $('#njopTanahObjekPajak').val(data.NJOPBUMI);
                        }
