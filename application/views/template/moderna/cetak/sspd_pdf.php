...
<?php if (isset($do)) { ?>
            ...
            <?php if (!strpos($lembar_no, '.')) { ?>
                <table class="cetak-form">
                    <thead>
                        <tr>
                            <th colspan="3">
                                <img src="<?php echo base_url() ?>assets/img/logo-bantul-small-hp.png" height="10%" class="logo"><br/>PEMERINTAH KAB.<br/>BANTUL
                            </th>
                            <th colspan="5">
                    ...
                    <tbody>
                        ...
                        <tr class="border-top">
                            ...
                            <td class="border-right" colspan="5">
                                <?php $nop = str_split($sspd['nopPBB']);
                                $arr_spasi = array(1, 3, 6, 9, 12, 16); ?>
        ...
        <?php } ?>
            ...
            <tr class="border-top border-bottom">
                <td colspan="9" class="border-left border-right no-padding">
                    <table class="table-ttd" class="border-all">
                        <tbody class="border-all">
                            <tr>
    ...
    <?php } else { ?>
        <table class="cetak-form" border="1">
            <thead>
                <tr>
                    <th colspan="3">
                        <img src="<?php echo base_url() ?>assets/img/logo-bantul-small-hp.png" class="logo" height="10%"><br/>PEMERINTAH KAB.<br/>BANTUL
                    </th>
                    <th colspan="5">
                        <h3>SURAT SETORAN PAJAK DAERAH<br/>SSPD</h3>
                        <h5>BEA PEROLEHAN HAK ATAS TANAH DAN BANGUNAN</h5>
            ...
            <tbody>
                <tr class="border-top border-bottom">
                    <td class="border-left border-right" colspan="9">
                        <table id="table-lampiran" border="1">
                            <thead>
                            <th>No</th>
                            <th>NOP</th>
                            ...
                            <tbody>
                                ...
                                $no = 1;
                                $total_detail = 0;
                                if (!empty($sspd_detail))
                                    foreach ($sspd_detail as $index => $detail) {
                                        ?>
                                        <tr>
                                            <td><?php echo $no ?></td>
                ...
                $no++;
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td ><?php echo rupiah($total_detail); ?></td>
                                </tr>
                            </tfoot>
                        </table>
                    </td>
...
<?php if (count($arr_lembar) > 1) { ?>
    ...
    <br>
    <p>Terlampir dokumen sebagai berikut:</p>
    <table>
        <tr>
            <td>1. Foto Copy PBB 2018</td>
        </tr>
        <tr>
            <td>2. Foto Copy Identitas Wajib Pajak berupa KTP</td>
        </tr>
        <tr>
            <td>3. Foto Copy Sertipikat Tanah/ Letter C</td>
        </tr>
    </table>
    <br>
    <table>
