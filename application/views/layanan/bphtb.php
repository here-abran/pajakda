					...
					<table class="table-sspd">
						...
						<tbody id="step2" style="display: none">
							...
							<tr>
								...
								<td colspan='5'><input type="text" name="hargaTransaksi" id="hargaTransaksi" class="form-control numeric" required="required"></td>
							</tr>
							<tr>
								<td colspan="8">&nbsp;</td>
							</tr>
				...
				<div class="modal-body">
					...
					<table class="input-objek-pajak">
						<tr>
							...
							<td><input type="text" name="lokasiObjekPajak" id="lokasiObjekPajak" class="form-control" value="" required="required" maxlength="255" readonly></td>
							<td style="width: 220px;">3. Blok/Kav/Nomor <span class="required">*</span></td>
							<td><input type="text" name="blokObjekPajak" id="blokObjekPajak" class="form-control" value="" required="required" maxlength="50" readonly></td>
						</tr>
						<tr>
							<td>4. RT/RW <span class="required">*</span></td>
							<td><input type="text" name="rtObjekPajak" id="rtObjekPajak" class="form-control" value="" required="required" maxlength="20" readonly></td>
							<td>5. Kabupaten <span class="required">*</span></td>
							<td>
					...
					<table class="input-objek-pajak">
						...
						<tr>
							...
							<td><input type="text" name="luasTanahObjekPajak" id="luasTanahObjekPajak" value="0" class="form-control numeric" value="0"  required="required" readonly></td>
							<td>12. NJOP Bumi <span class="required">*</span></td>
							<td><input type="text" name="njopTanahObjekPajak" id="njopTanahObjekPajak" value="0" class="form-control numeric" value="0"  required="required" readonly></td>
						</tr>
						<tr>
							<td>13. Luas Bangunan (m<sup>2</sup>) <span class="required">*</span></td>
							<td><input type="text" name="luasBangunanObjekPajak" id="luasBangunanObjekPajak" value="0" class="form-control numeric" value="0" required="required" readonly></td>
							<td>14. NJOP Bangunan <span class="required">*</span></td>
							<td><input type="text" name="njopBangunanObjekPajak" id="njopBangunanObjekPajak" value="0" class="form-control numeric" value="0" required="required" readonly></td>
						</tr>
						<tr>
							<td>15. Luas Bumi (sesuai sertifikat) <span class="required">*</span></td>
							<td><input type="text" name="luasBumiSertifikatObjekPajak" value="0" id="luasBumiSertifikatObjekPajak" class="form-control numeric" value="0" required="required"></td>
							<td>16. Luas Bangunan (sesuai sertifikat)<span class="required">*</span></td>
							<td><input type="text" name="luasBangunanSertifikatObjekPajak"  value="0" id="luasBangunanSertifikatObjekPajak" class="form-control numeric" value="0" required="required"></td>
						</tr>
					</table>
					<br/>
					<center>
